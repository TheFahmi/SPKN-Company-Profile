...
const CompanyOverview: React.FC<CompanyOverviewProps> = ({ isVisible }) => {
  const values = [
    {
      icon: <CheckCircleIcon color="primary" />,
      title: 'Kualitas',
      description: 'Kami berkomitmen untuk memberikan produk dan layanan berkualitas tinggi yang memenuhi standar industri dan harapan pelanggan.'
    },
    {
      icon: <VerifiedIcon color="primary" />,
      title: 'Integritas',
      description: 'Kami menjalankan bisnis dengan kejujuran, transparansi, dan etika yang tinggi dalam setiap aspek operasional kami.'
    },
    {
      icon: <GroupsIcon color="primary" />,
      title: 'Kepuasan Pelanggan',
      description: 'Kami mengutamakan kepuasan pelanggan dan berusaha untuk melebihi harapan mereka melalui layanan yang responsif dan solusi yang inovatif.'
    },
    {
      icon: <EmojiObjectsIcon color="primary" />,
      title: 'Inovasi',
      description: 'Kami terus mengembangkan teknologi dan proses baru untuk meningkatkan kualitas produk dan efisiensi operasional.'
    }
  ];
